...
1. Manually counts the exact pixels in the clipped raster.
...
This guarantees that the data presented on the dashboard perfectly reflects the underlying spatial reality of the clipped map.
